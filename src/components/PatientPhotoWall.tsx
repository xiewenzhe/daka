...
type PatientPhotoWallProps = {
  checkins: Checkin[];
  schedules: MedicineSchedule[];
};

export function PatientPhotoWall({ checkins, schedules }: PatientPhotoWallProps) {
  ...
  return (
    <section className="rounded-lg bg-white p-4 shadow-soft ring-1 ring-brand-100">
      <div>
        <p className="text-sm font-semibold text-brand-700">打卡照片墙</p>
        <h2 className="mt-1 text-xl font-bold text-slate-950">嘉嘉的照片记录</h2>
      </div>
